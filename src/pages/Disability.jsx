...
export default function Disability() {
  ...
  return (
    <div className="bg-[#0A0A0A] min-h-screen">
      <title>Disability Insurance Alberta | Frank Cover — Income Protection</title>
      <StickyHeader onCTAClick={scrollToForm} funnel="disability" />
      ...
      <TransparencySection />
      <div ref={formRef}>
        <LeadCapture funnel="disability" />
      </div>
      <FAQ />
      <CrossSell currentFunnel="disability" onCTAClick={scrollToForm} />
      <ClosingCTA onCTAClick={scrollToForm} headline="Ready to protect your income if you can't work?" />
      <Footer />
      <FloatingCTA onCTAClick={scrollToForm} label="Protect My Income" />
      <ExitIntentModal funnel="disability" />
    </div>
  );
}
